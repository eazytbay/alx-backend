...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    """ A  function called index_range that takes 2 integer arguments (
    page, page_size)
...
class Server:
    """A Server class that paginates a database of popular baby names.
    """
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Accepts 2 integer arguments and returns the epxected page from the dataset
        Args:
